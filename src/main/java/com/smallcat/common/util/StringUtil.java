...
public class StringUtil {
	 ...
	 * @param value
	 * @return
	 * @deprecated, use HashKit.digestSHA1
	 */
	private static HashKit kit = new HashKit();
	private static Coder b64 = new Base64Coder();
	public static byte[] digestSHA1(String value) {
		return b64.decode(kit.digestSHA1(value));
	}
	 ...
	 * @throws IOException 
	 */
	public static String digestSHA1(InputStream stream) throws IOException {
		return kit.digestSHA1(stream);
	}
	/**
	 * 转换为十六进制格式（小写）
	 * 
	...
	/**
	 * 服务记录的数据项组织成字符串
	 * @param 交易状态/货币码/简要说明/交易金额/简要说明里的参数串
	 * @author fanli
	 * @return
	 */
